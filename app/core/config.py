...
def _worker_count() -> int:
    value = (os.getenv("WORKER_COUNT") or os.getenv("WORKER_MODE") or "24").strip().lower()
    try:
...
class Settings:
    ...
    auto_rotate_interval_min_seconds: int = _int("AUTO_ROTATE_INTERVAL_MIN_SECONDS", 30)
    auto_rotate_interval_max_seconds: int = _int("AUTO_ROTATE_INTERVAL_MAX_SECONDS", 50)
    ...
    auto_rotate_max_uptime_seconds: int = _int("AUTO_ROTATE_MAX_UPTIME_SECONDS", 50)
